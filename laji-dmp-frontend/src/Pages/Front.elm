...
view model =
  ...
  , body =
      Html.div []
        ...
        , Html.p [] [ text "Ennen kuin kirjaudut Lajitietokeskus-tilillä sovellukseen, tilisi tulee liittää organisaatioon. Lähetä viestiä osoitteeseen helpdesk@laji.fi ja ilmoita, mihin organisaatioon kuulut. Odota vastausta ja sitten voit kirjautua sovellukseen." ]
        ...
        , Html.p [] [ text "Ongelmatilanteissa ota yhteyttä helpdesk@laji.fi" ]
